...
import React__default, { useState, useEffect, useRef, cloneElement, useContext, Fragment } from 'react';
import * as ra from 'react-admin';
import { fetchUtils, useDataProvider, useRefresh, Logout, CreateButton, useLogin } from 'react-admin';
...
const ListActions = props => {
  ...
  return /*#__PURE__*/React__default.createElement(ra.TopToolbar, _extends({
    className: className
...
function ReferenceInputWidget(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Grid, {
    ...
    renderInput: params => /*#__PURE__*/React__default.createElement(TextField$1, _extends({}, params, {
...
const TextField = props => {
  ...
  return /*#__PURE__*/React__default.createElement(ra.TextField, _extends({}, props, {
    source: source
  }));
};
const isEqual = (a, b) => {
...
const Resource = props => {
  ...
  }, /*#__PURE__*/React__default.createElement(ra.Resource, _extends({
    list: List,
    create: Create,
    edit: Edit
  }, props)));
...
const enumInput = (fieldProps, fieldSchema) => {
  ...
  return /*#__PURE__*/React__default.createElement(ra.SelectInput, _extends({}, fieldProps, {
    choices: choices
  }));
};
...
const AppBarDropdown = props => {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(List$1, null, /*#__PURE__*/React__default.createElement(ListSubheader$1, null, "Accounts"), accounts.map((account, i) => /*#__PURE__*/React__default.createElement(ListItem, {
    key: i,
    button: true,
    value: account.id,
    ...
    light: true
  })), /*#__PURE__*/React__default.createElement(Logout, _extends({}, props, {
...
const BackButton = ({
  ...
  children,
  ...props
}) => /*#__PURE__*/React__default.createElement(Button, _extends({}, props, {
  onClick: goBack
}), children);
...
var ImportButton = (props => {
  ...
  if (!schema) return;
  return /*#__PURE__*/React__default.createElement(ImportButton$1, _extends({
...
const Admin = ({
  ...
  const RAdmin = () => /*#__PURE__*/React__default.createElement(ra.Admin, _extends({
...
const List = props => {
  ...
  return /*#__PURE__*/React__default.createElement(ra.List, _extends({}, props, {
...
const toField = ([key, fieldSchema]) => {
  ...
  switch (fieldSchema.type) {
    case 'string':
      return fieldSchema.format === 'date-time' ? /*#__PURE__*/React__default.createElement(ra.DateField, _extends({}, fieldProps, {
        showTime: true
...
const refField = ({
  ...
  return /*#__PURE__*/React__default.createElement(ra.ReferenceField, _extends({
...
const enumField = (fieldProps, fieldSchema) => {
  ...
  return /*#__PURE__*/React__default.createElement(ra.SelectField, _extends({}, fieldProps, {
    choices: choices,
