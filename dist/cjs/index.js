...
require('autosuggest-highlight/parse');
...
const AppBarDropdown = props => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    light: true
  })), /*#__PURE__*/React__default['default'].createElement(ra.Logout, _extends$1({}, props, {
...
const Admin = ({
  ...
  const RAdmin = () => /*#__PURE__*/React__default['default'].createElement(ra__namespace.Admin, _extends$1({
...
const TextField = props => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ra__namespace.TextField, _extends$1({}, props, {
    source: source
  }));
};
const isEqual = (a, b) => {
...
const useStyles$2 = styles$1.makeStyles(theme => ({
  icon: {
    color: theme.palette.text.secondary,
...
function ReferenceInputWidget(props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement(Grid__default['default'], {
    ...
    renderInput: params => /*#__PURE__*/React__default['default'].createElement(TextField__default['default'], _extends$1({}, params, {
...
var ImportButton = (props => {
  ...
  if (!schema) return;
  return /*#__PURE__*/React__default['default'].createElement(reactAdminImportCsv.ImportButton, _extends$1({
...
const ListActions = props => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ra__namespace.TopToolbar, _extends$1({
    className: className
...
const enumInput = (fieldProps, fieldSchema) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ra__namespace.SelectInput, _extends$1({}, fieldProps, {
    choices: choices
  }));
};
...
const List = props => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ra__namespace.List, _extends$1({}, props, {
...
const toField = ([key, fieldSchema]) => {
  ...
  switch (fieldSchema.type) {
    case 'string':
      return fieldSchema.format === 'date-time' ? /*#__PURE__*/React__default['default'].createElement(ra__namespace.DateField, _extends$1({}, fieldProps, {
        showTime: true
...
const refField = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement(ra__namespace.ReferenceField, _extends$1({
...
const enumField = (fieldProps, fieldSchema) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(ra__namespace.SelectField, _extends$1({}, fieldProps, {
    choices: choices,
...
const Resource = props => {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(ra__namespace.Resource, _extends$1({
    list: List,
    create: Create,
    edit: Edit
  }, props)));
